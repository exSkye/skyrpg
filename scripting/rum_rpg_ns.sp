...
// custom L4D2_SetEntityGlow was needed so a modified version of these functions here
#include "rpg/Stocks/MrZeroStocks.sp"
...
stock LoadMainConfig() {
	...
	fAdrenHealAmount					= GetConfigValueFloat("on use adren heal?", 0.2);
