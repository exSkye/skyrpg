	...
	if (StrEqual(event_name, "player_spawn")) {
		if (IsLegitimateClientAttacker) {
			...
			if (myCurrentTeam[attacker] == TEAM_SURVIVOR && !b_IsHooked[attacker]) {
				...
				if (attackerZombieClass == 1) L4D2_SetEntityGlow(attacker, L4D2Glow_Constant, 500, 1, {0, 80, 0}, false);
				else if (attackerZombieClass == 2) L4D2_SetEntityGlow(attacker, L4D2Glow_Constant, 500, 1, {128, 0, 128}, false);
				else if (attackerZombieClass == 3) L4D2_SetEntityGlow(attacker, L4D2Glow_Constant, 500, 1, {80, 0, 0}, false);
				else if (attackerZombieClass == 4) L4D2_SetEntityGlow(attacker, L4D2Glow_Constant, 500, 1, {0, 80, 0}, false);
				else if (attackerZombieClass == 5) L4D2_SetEntityGlow(attacker, L4D2Glow_Constant, 500, 1, {80, 0, 0}, false);
				else if (attackerZombieClass == 6) L4D2_SetEntityGlow(attacker, L4D2Glow_Constant, 500, 1, {80, 0, 0}, false);
