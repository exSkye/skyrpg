...
stock GiveClientStoreItem(client, pos) {
	...
	Duration		= StringToInt(GetKeyValue(Give_Store_Keys, Give_Store_Values, "duration?"));
	Format(ItemEffect, sizeof(ItemEffect), "%s", GetKeyValue(Give_Store_Keys, Give_Store_Values, "item effect?"));
	Amount			= StringToInt(GetKeyValue(Give_Store_Keys, Give_Store_Values, "amount?"));
	AmountMin		= StringToFloat(GetKeyValue(Give_Store_Keys, Give_Store_Values, "amount min?"));
	AmountMax		= StringToFloat(GetKeyValue(Give_Store_Keys, Give_Store_Values, "amount max?"));
