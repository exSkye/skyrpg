...
public Handle:TeamManagerRankings (client)
{
	...
	DrawPanelText(menu, text);
	Format(text, sizeof(text), "%T", "Common Kills Rank", client, AddCommasToString(CommonKills[client]), AddCommasToString(CommonKillsAverage[client]), CommonRank[client], CommonKillsAverageRank[client]);
	DrawPanelText(menu, text);
	Format(text, sizeof(text), "%T", "Special Kills Rank", client, AddCommasToString(SpecialKills[client]), SpecialRank[client]);
	DrawPanelText(menu, text);
	Format(text, sizeof(text), "%T", "Survivor Damage Rank", client, AddCommasToString(SurvivorDamage[client]), AddCommasToString(SurvivorDamageAverage[client]), SurvivorDamageRank[client], SurvivorDamageAverageRank[client]);
	DrawPanelText(menu, text);
	Format(text, sizeof(text), "%T", "Survivor Rescues Rank", client, AddCommasToString(Rescues[client]));
	DrawPanelText(menu, text);
	Format(text, sizeof(text), "%T", "Survivor Incaps Rank", client, AddCommasToString(SurvivorIncaps[client]));
	DrawPanelText(menu, text);
	Format(text, sizeof(text), "%T", "Infected Damage Rank", client, AddCommasToString(InfectedDamage[client]), AddCommasToString(InfectedDamageAverage[client]), InfectedDamageRank[client], InfectedDamageAverageRank[client]);
	DrawPanelText(menu, text);
	Format(text, sizeof(text), "%T", "Infected Incaps Rank", client, AddCommasToString(InfectedIncaps[client]));
	DrawPanelText(menu, text);
...
public GetClientRank(client)
{
	...
	CommonKillsAverageRank[client] + SurvivorDamageAverageRank[client] + InfectedDamageAverageRank[client]) / 7;
